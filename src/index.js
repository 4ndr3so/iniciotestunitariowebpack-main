...
console.log(prueba.getLongestSubsequence(["a","b","c","d"],[1,0,1,1]))
//console.log(prueba.smallestPositiveinteger([1,2,3]))
...
//console.log(prueba.findComplement2(6))
//console.log(prueba.islandPerimeter([[0,1,0,0],[1,1,1,0],[0,1,0,0],[1,1,0,0]]))
//console.log(prueba.hammingDistance2(93,73))
//console.log(prueba.findContentChildren2([1,2],[1,2,3]))
//console.log(prueba.findContentChildren([1,2],[1,2,3]))
...
/* console.log(prueba.longestPalindrome("aaabccccdd"))
